...
ST7701S_handle ST7701S_newObject(int SDA, int SCL, int CS, char channel_select,
    ...
    if (method_select) {
        ...
        ESP_ERROR_CHECK(spi_bus_initialize(channel_select, &(st7701s_handle->spi_io_config_t),
                                           SPI_DMA_CH_AUTO));
        ...
        ESP_ERROR_CHECK(spi_bus_add_device(channel_select,
                                           &(st7701s_handle->st7701s_protocol_config_t),
